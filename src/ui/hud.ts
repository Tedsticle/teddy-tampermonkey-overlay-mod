...
import { AutoFeedService } from "../services/autoFeed";
import {
  getKeybind,
  getKeybindLabel,
...
export function mountHUD(opts?: HUDOptions) {
  ...
  box.innerHTML = `
    <div class="row drag">
      <div class="title">Teddy's Magic Helper</div>
      <div class="sp"></div>
  ...
  (function initVersionBadge() {
    ...
    sVersion.textContent = localVersion || "unknown";
    tag(sVersion, "ok");
  })();
...
export function initWatchers(){
    ...
    (async () => {
        ...
        try { await AutoFeedService.start(); } catch {}
